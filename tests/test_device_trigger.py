"""Tests for Better Trucks device triggers."""
from custom_components.better_trucks.const import DOMAIN
from custom_components.better_trucks.device_trigger import (
    TRIGGER_EVENTS,
    async_get_triggers,
)
