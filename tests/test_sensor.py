"""Tests for Better Trucks sensor property logic."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.better_trucks.const import ParcelStatus
from custom_components.better_trucks.sensor import (
    BetterTrucksDeliveredParcelsSensor,
    BetterTrucksIncomingParcelsSensor,
    BetterTrucksLastUpdateSensor,
    BetterTrucksNextDeliverySensor,
    BetterTrucksParcelSensor,
)
...
def test_incoming_counts_and_lists():
    ...
    sensor = BetterTrucksIncomingParcelsSensor(coordinator, _entry(), lambda _: None, set())
...
def test_parcel_sensor_status_and_attributes():
    ...
    sensor = BetterTrucksParcelSensor(_coordinator([parcel]), _entry(), "A")
...
def test_parcel_sensor_missing_barcode():
    sensor = BetterTrucksParcelSensor(_coordinator([_parcel("A")]), _entry(), "OTHER")
...
def test_next_delivery_picks_earliest():
    ...
    sensor = BetterTrucksNextDeliverySensor(coordinator, _entry())
...
def test_next_delivery_none_without_moments():
    sensor = BetterTrucksNextDeliverySensor(_coordinator([_parcel("A")]), _entry())
    assert sensor.native_value is None
    assert sensor.extra_state_attributes == {}
...
def test_delivered_sensor():
    ...
    sensor = BetterTrucksDeliveredParcelsSensor(coordinator, _entry())
...
def test_last_update_sensor():
    ...
    sensor = BetterTrucksLastUpdateSensor(coordinator, _entry())
